...
export default function DeleteItemModal({ visible, setVisible, deleteHandler, loading, selectedItemToDelete }) {
  return (
    <AlertDialog open={visible} onOpenChange={setVisible}>
      ...
      >
        <Text className="font-bold text-xl">Delete Item</Text>
